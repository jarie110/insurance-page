<template>
  <a-card :bordered="false">
    ...
    <insurance-team-modal ref="modalForm" @ok="modalFormOk"></insurance-team-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/team/insuranceTeam/list",
          delete: "/team/insuranceTeam/delete",
